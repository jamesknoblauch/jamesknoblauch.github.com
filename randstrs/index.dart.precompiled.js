...
Interceptor: {"": "Object;",
  ...
  "%": "Crypto|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedNumberList"
},
...
InputElement: {"": "HtmlElement;checked%,disabled},name=,value%", $isElement: true, $isEventTarget: true, "%": "HTMLInputElement"},
...
PreElement: {"": "HtmlElement;", $isPreElement: true, "%": "HTMLPreElement"},
...
["main", "index.dart", , U, {
main: function() {
  new R.RandstrsApp(null, null).random_password_page$0();
  G.NavBar$("random");
}},
1],
["", "package:randstrs/src/nav_bar.dart", , G, {
NavBar: {"": "Object;page_name,nav_list_left,nav_list_right,nav_list",
  set_active$1: function(page_name) {
    var t1, li, t2, t3;
    for (t1 = this.nav_list, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
      li = t1._current;
      t2 = J.getInterceptor$x(li);
      t3 = t2.querySelector$1(li, "a").textContent;
      if (t3 == null ? page_name == null : t3 === page_name) {
        t2 = t2.get$classes(li);
        t2.add$1(t2, "active");
      } else {
        t2 = t2.get$classes(li);
  ...
  handle_nav_click$1: function(e) {
    this.set_active$1(H.interceptedTypeCast(J.get$currentTarget$x(e), "$isAnchorElement").textContent);
  },
  get$handle_nav_click: function() {
    return new H.BoundClosure$1(this, G.NavBar.prototype.handle_nav_click$1, null, "handle_nav_click$1");
  },
  NavBar$1: function(page_name) {
    var t1, a, t2, t3, $arguments, t4;
    t1 = this.nav_list;
    C.JSArray_methods.addAll$1(t1, J.get$children$x(this.nav_list_left));
    C.JSArray_methods.addAll$1(t1, J.get$children$x(this.nav_list_right));
    this.set_active$1(this.page_name);
    for (t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
      a = J.querySelector$1$x(t1._current, "a");
      a.toString;
      t2 = new W._ElementEventStreamImpl(a, C.EventStreamProvider_click._eventType, false);
      t2.$builtinTypeInfo = [null];
      t3 = this.get$handle_nav_click();
      $arguments = H.substitute(t2.$as_EventStream, H.getRuntimeTypeInfo(t2));
      t4 = $arguments == null ? null : $arguments[0];
      t2 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t3), t2._useCapture);
  ...
  static: {
NavBar$: function(page_name) {
  var t1, t2, t3;
  t1 = document.querySelector("#nav_list_left");
  t2 = document.querySelector("#nav_list_right");
  t3 = P.List_List(null, W.Element);
  H.setRuntimeTypeInfo(t3, [W.Element]);
  t3 = new G.NavBar(page_name, t1, t2, t3);
  t3.NavBar$1(page_name);
  return t3;
}}

}}],
["option_panel", "package:randstrs/src/option_panel.dart", , Q, {
RandomOptionPanel: {"": "Object;length_input,repeat_input,length>,repeat,default_length,default_repeat,all_chars_checkbox,upper_checkbox,lower_checkbox,digits_checkbox,special_checkbox,use_all,use_upper,use_lower,use_digits,use_special,custom_checkbox,use_custom,custom_input,custom_chars,pattern_checkbox,use_pattern,pattern_input,pattern,gen_button,clear_button",
  reset$0: function(_) {
    J.set$disabled$x(this.length_input, false);
    J.set$value$x(this.length_input, "12");
    this.length = 12;
    J.set$value$x(this.repeat_input, "0");
    this.repeat = 0;
    J.set$checked$x(this.custom_checkbox, false);
    J.set$disabled$x(this.custom_checkbox, false);
    this.use_custom = false;
    this.custom_chars = "";
    J.set$value$x(this.custom_input, "");
    J.set$disabled$x(this.custom_input, this.use_custom !== true);
    J.set$checked$x(this.pattern_checkbox, false);
    this.use_pattern = false;
    this.pattern = "";
    J.set$value$x(this.pattern_input, "");
    J.set$disabled$x(this.pattern_input, this.use_pattern !== true);
    J.set$checked$x(this.all_chars_checkbox, true);
    J.set$disabled$x(this.all_chars_checkbox, false);
    this.set_all_chars$1(true);
  },
  length_change_handler$1: function(e) {
    var exception, t1;
    try {
      this.length = H.Primitives_parseInt(J.get$value$x(this.length_input), null, null);
    } catch (exception) {
      H.unwrapException(exception);
      t1 = this.default_length;
      this.length = t1;
      J.set$value$x(this.length_input, C.JSInt_methods.toString$0(t1));
    }

  },
  get$length_change_handler: function() {
    return new H.BoundClosure$1(this, Q.RandomOptionPanel.prototype.length_change_handler$1, null, "length_change_handler$1");
  },
  repeat_change_handler$1: function(e) {
    var exception, t1;
    try {
      this.repeat = H.Primitives_parseInt(J.get$value$x(this.repeat_input), null, null);
    } catch (exception) {
      H.unwrapException(exception);
      t1 = this.default_repeat;
      this.repeat = t1;
      J.set$value$x(this.repeat_input, C.JSInt_methods.toString$0(t1));
    }

  },
  get$repeat_change_handler: function() {
    return new H.BoundClosure$1(this, Q.RandomOptionPanel.prototype.repeat_change_handler$1, null, "repeat_change_handler$1");
  },
  set_all_chars$1: function(t) {
    this.use_all = t;
    J.set$disabled$x(this.upper_checkbox, t);
    J.set$checked$x(this.upper_checkbox, t);
    this.use_upper = t;
    J.set$disabled$x(this.lower_checkbox, t);
    J.set$checked$x(this.lower_checkbox, t);
    this.use_lower = t;
    J.set$disabled$x(this.digits_checkbox, t);
    J.set$checked$x(this.digits_checkbox, t);
    this.use_digits = t;
    J.set$disabled$x(this.special_checkbox, t);
    J.set$checked$x(this.special_checkbox, t);
    this.use_special = t;
  },
  all_chars_change_handler$1: function(_) {
    this.set_all_chars$1(J.get$checked$x(this.all_chars_checkbox));
  },
  get$all_chars_change_handler: function() {
    return new H.BoundClosure$1(this, Q.RandomOptionPanel.prototype.all_chars_change_handler$1, null, "all_chars_change_handler$1");
  },
  upper_change_handler$1: function(_) {
    this.use_upper = J.get$checked$x(this.upper_checkbox);
  },
  get$upper_change_handler: function() {
    return new H.BoundClosure$1(this, Q.RandomOptionPanel.prototype.upper_change_handler$1, null, "upper_change_handler$1");
  },
  lower_change_handler$1: function(_) {
    this.use_lower = J.get$checked$x(this.lower_checkbox);
  },
  get$lower_change_handler: function() {
    return new H.BoundClosure$1(this, Q.RandomOptionPanel.prototype.lower_change_handler$1, null, "lower_change_handler$1");
  },
  digits_change_handler$1: function(_) {
    this.use_digits = J.get$checked$x(this.digits_checkbox);
  },
  get$digits_change_handler: function() {
    return new H.BoundClosure$1(this, Q.RandomOptionPanel.prototype.digits_change_handler$1, null, "digits_change_handler$1");
  },
  special_change_handler$1: function(_) {
    this.use_special = J.get$checked$x(this.special_checkbox);
  },
  get$special_change_handler: function() {
    return new H.BoundClosure$1(this, Q.RandomOptionPanel.prototype.special_change_handler$1, null, "special_change_handler$1");
  },
  custom_change_handler$1: function(_) {
    this.use_custom = J.get$checked$x(this.custom_checkbox);
    J.set$disabled$x(this.custom_input, this.use_custom !== true);
  },
  get$custom_change_handler: function() {
    return new H.BoundClosure$1(this, Q.RandomOptionPanel.prototype.custom_change_handler$1, null, "custom_change_handler$1");
  },
  custom_input_change_handler$1: function(_) {
    this.custom_chars = J.toString$0(J.get$value$x(this.custom_input));
  },
  get$custom_input_change_handler: function() {
    return new H.BoundClosure$1(this, Q.RandomOptionPanel.prototype.custom_input_change_handler$1, null, "custom_input_change_handler$1");
  },
  pattern_change_handler$1: function(_) {
    var t1;
    this.use_pattern = J.get$checked$x(this.pattern_checkbox);
    J.set$disabled$x(this.pattern_input, this.use_pattern !== true);
    J.set$value$x(this.pattern_input, "");
    this.pattern = "";
    J.set$disabled$x(this.length_input, this.use_pattern);
    t1 = this.default_length;
    J.set$value$x(this.length_input, C.JSInt_methods.toString$0(t1));
    this.length = t1;
    this.set_all_chars$1(this.use_pattern !== true);
    J.set$disabled$x(this.all_chars_checkbox, this.use_pattern);
    J.set$checked$x(this.all_chars_checkbox, this.use_pattern !== true);
    this.use_all = this.use_pattern !== true;
    J.set$disabled$x(this.upper_checkbox, true);
    J.set$disabled$x(this.lower_checkbox, true);
    J.set$disabled$x(this.digits_checkbox, true);
    J.set$disabled$x(this.special_checkbox, true);
    J.set$disabled$x(this.custom_checkbox, this.use_pattern);
    J.set$checked$x(this.custom_checkbox, false);
    this.use_custom = false;
    J.set$disabled$x(this.custom_input, true);
    J.set$value$x(this.custom_input, "");
    this.custom_chars = "";
  },
  get$pattern_change_handler: function() {
    return new H.BoundClosure$1(this, Q.RandomOptionPanel.prototype.pattern_change_handler$1, null, "pattern_change_handler$1");
  },
  pattern_input_change_handler$1: function(_) {
    this.pattern = J.toString$0(J.get$value$x(this.pattern_input));
  },
  get$pattern_input_change_handler: function() {
    return new H.BoundClosure$1(this, Q.RandomOptionPanel.prototype.pattern_input_change_handler$1, null, "pattern_input_change_handler$1");
  },
  RandomOptionPanel$0: function() {
    var t1, t2, t3;
    this.length_input = document.querySelector("#length_input");
    t1 = this.length_input;
    t1.toString;
    t2 = C.EventStreamProvider_change._eventType;
    t1 = new W._ElementEventStreamImpl(t1, t2, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t3 = this.get$length_change_handler();
    ...
    t3._tryResume$0();
    t3 = this.default_length;
    J.set$value$x(this.length_input, C.JSInt_methods.toString$0(t3));
    this.length = t3;
    this.repeat_input = document.querySelector("#repeat_input");
    t3 = this.repeat_input;
    t3.toString;
    t3 = new W._ElementEventStreamImpl(t3, t2, false);
    H.setRuntimeTypeInfo(t3, [null]);
    t1 = this.get$repeat_change_handler();
    ...
    J.set$value$x(this.repeat_input, C.JSInt_methods.toString$0(t1));
    this.repeat = t1;
    this.upper_checkbox = document.querySelector("#upper_chars");
    t1 = this.upper_checkbox;
    t1.toString;
    t1 = new W._ElementEventStreamImpl(t1, t2, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t3 = this.get$upper_change_handler();
    t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(t3), t1._useCapture);
    H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t3._tryResume$0();
    this.lower_checkbox = document.querySelector("#lower_chars");
    t3 = this.lower_checkbox;
    t3.toString;
    t3 = new W._ElementEventStreamImpl(t3, t2, false);
    H.setRuntimeTypeInfo(t3, [null]);
    t1 = this.get$lower_change_handler();
    t1 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(t1), t3._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t3, "_EventStream", 0)]);
    t1._tryResume$0();
    this.digits_checkbox = document.querySelector("#digit_chars");
    t1 = this.digits_checkbox;
    t1.toString;
    t1 = new W._ElementEventStreamImpl(t1, t2, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t3 = this.get$digits_change_handler();
    t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(t3), t1._useCapture);
    H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t3._tryResume$0();
    this.special_checkbox = document.querySelector("#special_chars");
    t3 = this.special_checkbox;
    t3.toString;
    t3 = new W._ElementEventStreamImpl(t3, t2, false);
    H.setRuntimeTypeInfo(t3, [null]);
    t1 = this.get$special_change_handler();
    t1 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(t1), t3._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t3, "_EventStream", 0)]);
    t1._tryResume$0();
    this.custom_checkbox = document.querySelector("#custom_checkbox");
    t1 = this.custom_checkbox;
    t1.toString;
    t1 = new W._ElementEventStreamImpl(t1, t2, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t3 = this.get$custom_change_handler();
    t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(t3), t1._useCapture);
    H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t3._tryResume$0();
    this.use_custom = J.get$checked$x(this.custom_checkbox);
    this.custom_input = document.querySelector("#custom_input");
    t3 = this.custom_input;
    t3.toString;
    t3 = new W._ElementEventStreamImpl(t3, t2, false);
    H.setRuntimeTypeInfo(t3, [null]);
    t1 = this.get$custom_input_change_handler();
    t1 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(t1), t3._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t3, "_EventStream", 0)]);
    t1._tryResume$0();
    this.custom_chars = "";
    J.set$disabled$x(this.custom_input, this.use_custom !== true);
    this.all_chars_checkbox = document.querySelector("#all_chars");
    t1 = this.all_chars_checkbox;
    t1.toString;
    t1 = new W._ElementEventStreamImpl(t1, t2, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t3 = this.get$all_chars_change_handler();
    t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(t3), t1._useCapture);
    H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t3._tryResume$0();
    J.set$checked$x(this.all_chars_checkbox, true);
    this.set_all_chars$1(true);
    this.pattern_checkbox = document.querySelector("#pattern_checkbox");
    t3 = this.pattern_checkbox;
    t3.toString;
    t3 = new W._ElementEventStreamImpl(t3, t2, false);
    H.setRuntimeTypeInfo(t3, [null]);
    t1 = this.get$pattern_change_handler();
    t1 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(t1), t3._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t3, "_EventStream", 0)]);
    t1._tryResume$0();
    this.use_pattern = J.get$checked$x(this.pattern_checkbox);
    this.pattern_input = document.querySelector("#pattern_input");
    t1 = this.pattern_input;
    t1.toString;
    t2 = new W._ElementEventStreamImpl(t1, t2, false);
    H.setRuntimeTypeInfo(t2, [null]);
    t1 = this.get$pattern_input_change_handler();
    t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1), t2._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t1._tryResume$0();
    this.pattern = "";
    J.set$disabled$x(this.pattern_input, this.use_pattern !== true);
    this.gen_button = document.querySelector("#gen_button");
    this.clear_button = document.querySelector("#clear_button");
  },
  static: {
RandomOptionPanel$: function() {
  var t1 = new Q.RandomOptionPanel(null, null, null, null, 12, 0, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
  t1.RandomOptionPanel$0();
  return t1;
}}

}}],
["output_panel", "package:randstrs/src/output_panel.dart", , Q, {
OutputPanel: {"": "Object;table,body",
  add_item$1: function(item) {
    var row, types_used, pre, t1, t2, cell, char_types, key;
    row = document.createElement("tr", null);
    types_used = [];
    pre = document.createElement("pre", null);
    pre.textContent = item.toString$0(item);
    t1 = new W._ElementEventStreamImpl(pre, C.EventStreamProvider_click._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = this.get$handle_pre_click();
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(t2), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = J.get$classes$x(pre);
    t2.add$1(t2, "min-width-pre");
    cell = document.createElement("td", null);
    t2 = J.get$children$x(cell);
    t2.add$1(t2, pre);
    row.appendChild(cell);
    cell = document.createElement("td", null);
    t2 = item.length;
    t1 = Math.log(94);
    cell.textContent = J.toStringAsFixed$1$n(J.$mul$n(t2, t1 / Math.log(2)), 2);
    row.appendChild(cell);
    cell = document.createElement("td", null);
    cell.textContent = J.toStringAsFixed$1$n(item.get$pool_entropy(), 2);
    row.appendChild(cell);
    char_types = item.char_types$0();
    cell = document.createElement("td", null);
    for (t1 = char_types.get$keys()._map, t1 = new P.LinkedHashMapKeyIterator(t1, t1._modifications, null, null), t1._cell = t1._map._first; t1.moveNext$0();) {
      key = t1._collection$_current;
      if (char_types.$index(char_types, key) === true)
        types_used.push(key);
    }
    cell.textContent = C.JSArray_methods.join$1(types_used, ",");
    row.appendChild(cell);
    cell = document.createElement("td", null);
    t1 = item.items;
    t2 = P.HashSet_HashSet(null, null, null, H.getRuntimeTypeArgument(item, "RandomSequence", 0));
    t2.addAll$1(t2, t1);
    cell.textContent = "" + t2._length + " / " + H.S(item.length);
    row.appendChild(cell);
    if (item.score$0() < 80) {
      t1 = J.get$classes$x(row);
      t1.add$1(t1, "danger");
    } else {
      t1 = J.getInterceptor$x(row);
      if (item.score$0() < 110) {
        t1 = t1.get$classes(row);
        t1.add$1(t1, "warning");
      } else {
        t1 = t1.get$classes(row);
        t1.add$1(t1, "success");
  ...
  handle_pre_click$1: function(e) {
    var range = document.createRange();
    range.selectNodeContents(H.interceptedTypeCast(J.get$currentTarget$x(e), "$isPreElement"));
    window.getSelection().addRange(range);
  },
  get$handle_pre_click: function() {
    return new H.BoundClosure$1(this, Q.OutputPanel.prototype.handle_pre_click$1, null, "handle_pre_click$1");
  },
...
OutputPanel$: function() {
  var t1 = new Q.OutputPanel(null, null);
  t1.OutputPanel$0();
  return t1;
}}

}}],
["password", "package:randstrs/src/password.dart", , N, {
RandomPassword: {"": "RandomSequence;items,pool,length",
  toString$0: function(_) {
    return C.JSArray_methods.join$0(this.items);
  }
},

PatternPassword: {"": "RandomSequence;pattern,char_pools,char_count,items,pool,length",
  _parse_pattern$0: function() {
    var t1, t2, t3, t4, segment, cp, t5, end, count, char_set_code;
    t1 = H.JSSyntaxRegExp_makeNative("\\d+[auldsw]{1}", false, true, false);
    for (t2 = this.pattern.split(":"), t2 = new H.ListIterator(t2, t2.length, 0, null), t3 = this.char_pools, t4 = this.char_count, t1 = new H.JSSyntaxRegExp(t1, null, null)._nativeRegExp; t2.moveNext$0();) {
      segment = J.toLowerCase$0$s(t2._current);
      if (t1.test(segment)) {
        cp = new E.CharPool(null, new V.ClientSecureRandom());
        t5 = P.List_List(null, J.JSString);
        t5.$builtinTypeInfo = [J.JSString];
        cp.items = t5;
        end = segment.length - 1;
        count = H.Primitives_parseInt(C.JSString_methods.substring$2(segment, 0, end), null, null);
        t4.push(count);
        this.length = J.$add$ns(this.length, count);
        char_set_code = C.JSString_methods.substring$1(segment, end);
        if (char_set_code === "a")
          cp.add_ascii_all$0();
        else if (char_set_code === "u")
          cp.addAll$1(cp, "ABCDEFGHIJKLMNOPQRSTUVWXYZ");
        else if (char_set_code === "l")
          cp.addAll$1(cp, "abcdefghijklmnopqrstuvwxyz");
        else if (char_set_code === "d")
          cp.addAll$1(cp, "0123456789");
        ...
        throw H.wrapException(new P.ArgumentError(this.pattern));
    }
  },
  generate$0: function() {
    var t1, t2, i, j, t3, t4, t5;
    for (t1 = this.char_count, t2 = this.char_pools, i = 0; i < t1.length; ++i) {
      j = 0;
      while (true) {
        if (i >= t1.length)
          throw H.ioore(t1, i);
        ...
        t4 = t2[i];
        t5 = t4.items;
        t4 = t4.random.int_from_range$2(0, t5.length);
  ...
  get$pool_entropy: function() {
    var t1, t2, entropy, i, t3, t4;
    for (t1 = this.char_count, t2 = this.char_pools, entropy = 0, i = 0; i < t1.length; ++i) {
      t3 = t1[i];
      if (i >= t2.length)
        throw H.ioore(t2, i);
      t4 = t2[i].items.length;
      t4 = Math.log(t4);
      t3 = J.$mul$n(t3, t4 / Math.log(2));
      if (typeof t3 !== "number")
        throw H.iae(t3);
      entropy += t3;
    }
...
["pool", "package:randstrs/src/pool.dart", , E, {
CharPool: {"": "Object;items,random",
  add$1: function(_, c) {
    if (!C.JSArray_methods.contains$1(this.items, c)) {
      C.JSArray_methods.add$1(this.items, c);
      return true;
    } else
      return false;
  },
  addAll$1: function(_, s) {
    var t1, result;
    for (t1 = s.split(""), t1 = new H.ListIterator(t1, t1.length, 0, null), result = false; t1.moveNext$0();)
      result = this.add$1(this, t1._current) || result;
    return result;
  },
  add_ascii_all$0: function() {
    var u, l, d, s;
    u = this.addAll$1(this, "ABCDEFGHIJKLMNOPQRSTUVWXYZ");
    l = this.addAll$1(this, "abcdefghijklmnopqrstuvwxyz");
    d = this.addAll$1(this, "0123456789");
    s = this.addAll$1(this, "~`!@#$%^&*()-_=+[]{}\\|;:'\",.<>/?");
    return u || l || d || s;
  },
  get$length: function(_) {
  ...
  CharPool$2: function(random, size) {
    var t1 = P.List_List(null, J.JSString);
    H.setRuntimeTypeInfo(t1, [J.JSString]);
    this.items = t1;
  },
  static: {
"": "CharPool_ASCII_UPPER,CharPool_ASCII_LOWER,CharPool_ASCII_DIGITS,CharPool_ASCII_SPECIAL,CharPool_ASCII_WHITESPACE",
CharPool$: function(random, size) {
  var t1 = new E.CharPool(null, random);
  t1.CharPool$2(random, size);
  return t1;
}}

}}],
["random", "package:randstrs/src/random.dart", , V, {
ClientSecureRandom: {"": "Object;",
  int_from_range$2: function(min, max) {
    var buffer, t1, range, remainder, div;
    buffer = new Uint32Array(1);
    buffer.$dartCachedLength = buffer.length;
    window.crypto.getRandomValues(buffer);
    t1 = buffer[0];
    if (t1 === 4294967295)
      return this.int_from_range$2(min, max);
    range = max - min;
    remainder = C.JSInt_methods.$mod(4294967295, range);
    div = C.JSInt_methods.$tdiv(4294967295, range);
    return t1 < 4294967295 - remainder ? min + C.JSInt_methods.$tdiv(t1, div) : this.int_from_range$2(min, max);
  },
  static: {
"": "ClientSecureRandom_MAX_INT",
}

}}],
["random_sequence", "package:randstrs/src/random_sequence.dart", , D, {
RandomSequence: {"": "Object;length>",
  generate$0: function() {
    ...
    while (true) {
      ...
      t3 = this.items;
      t4 = t1.items;
      t5 = t2.int_from_range$2(0, t4.length);
  ...
  get$pool_entropy: function() {
    var t1, t2;
    t1 = this.length;
    t2 = this.pool.items.length;
    t2 = Math.log(t2);
    return J.$mul$n(t1, t2 / Math.log(2));
  },
  char_types$0: function() {
    var types_used, t1, i, t2;
    types_used = H.fillLiteralMap(["U", false, "L", false, "D", false, "S", false, "W", false], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    for (t1 = this.items, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
      i = t1._current;
      t2 = i == null;
      if (t2)
        H.throwExpression(new P.ArgumentError(null));
      types_used.$indexSet(types_used, "U", H.stringContainsUnchecked("ABCDEFGHIJKLMNOPQRSTUVWXYZ", i, 0) || types_used.$index(types_used, "U") === true);
      if (t2)
        H.throwExpression(new P.ArgumentError(null));
      types_used.$indexSet(types_used, "L", H.stringContainsUnchecked("abcdefghijklmnopqrstuvwxyz", i, 0) || types_used.$index(types_used, "L") === true);
      if (t2)
        H.throwExpression(new P.ArgumentError(null));
      types_used.$indexSet(types_used, "D", H.stringContainsUnchecked("0123456789", i, 0) || types_used.$index(types_used, "D") === true);
      if (t2)
        H.throwExpression(new P.ArgumentError(null));
      types_used.$indexSet(types_used, "S", H.stringContainsUnchecked("~`!@#$%^&*()-_=+[]{}\\|;:'\",.<>/?", i, 0) || types_used.$index(types_used, "S") === true);
      if (t2)
        H.throwExpression(new P.ArgumentError(null));
      types_used.$indexSet(types_used, "W", H.stringContainsUnchecked(" \t\r\n", i, 0) || types_used.$index(types_used, "W") === true);
    }
    return types_used;
  },
  score$0: function() {
    var t1, t2, score;
    for (t1 = this.char_types$0(), t1 = t1.get$values(t1), t2 = t1._iterable, t2 = t2.get$iterator(t2), t2 = new H.MappedIterator(null, t2, t1._f), H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "MappedIterable", 0), H.getRuntimeTypeArgument(t1, "MappedIterable", 1)]), score = 0; t2.moveNext$0();)
      if (t2._current === true)
        score += 2;
    t1 = this.length;
    t2 = Math.log(94);
    t1 = J.$add$ns(J.$mul$n(t1, t2 / Math.log(2)), this.get$pool_entropy());
    if (typeof t1 !== "number")
      throw t1.$div();
    return score + t1 / 2;
  }
}}],
["randstrs_app", "package:randstrs/src/randstrs_app.dart", , R, {
RandstrsApp: {"": "Object;option_panel,output_panel",
  random_password_page$0: function() {
    var t1, t2, t3;
    this.output_panel = Q.OutputPanel$();
    this.option_panel = Q.RandomOptionPanel$();
    t1 = this.option_panel.gen_button;
    t1.toString;
    t2 = C.EventStreamProvider_click._eventType;
    t1 = new W._ElementEventStreamImpl(t1, t2, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t3 = this.get$submit_handler();
    t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(t3), t1._useCapture);
    H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t3._tryResume$0();
    t3 = this.option_panel.clear_button;
    t3.toString;
    t2 = new W._ElementEventStreamImpl(t3, t2, false);
    H.setRuntimeTypeInfo(t2, [null]);
    t3 = this.get$clear_handler();
  ...
  submit_handler$1: function(e) {
    var i, t1, t2, t3, t4, t5, cp;
    if (this.option_panel.use_pattern === true) {
      i = 0;
      while (true) {
        t1 = this.option_panel;
        t2 = t1.repeat;
        if (typeof t2 !== "number")
          throw H.iae(t2);
        if (!(i <= t2))
          break;
        t2 = this.output_panel;
        t1 = t1.pattern;
        t3 = P.List_List(null, E.CharPool);
        t3.$builtinTypeInfo = [E.CharPool];
        t4 = P.List_List(null, J.JSInt);
        t4.$builtinTypeInfo = [J.JSInt];
        t5 = J.JSString;
        t4 = new N.PatternPassword(t1, t3, t4, null, null, 0);
      ...
      cp = E.CharPool$(new V.ClientSecureRandom(), null);
      t1 = this.option_panel;
      if (t1.use_all === true)
        cp.add_ascii_all$0();
      else {
        if (t1.use_upper === true)
          cp.addAll$1(cp, "ABCDEFGHIJKLMNOPQRSTUVWXYZ");
        if (this.option_panel.use_lower === true)
          cp.addAll$1(cp, "abcdefghijklmnopqrstuvwxyz");
        if (this.option_panel.use_digits === true)
          cp.addAll$1(cp, "0123456789");
        if (this.option_panel.use_special === true)
          cp.addAll$1(cp, "~`!@#$%^&*()-_=+[]{}\\|;:'\",.<>/?");
        t1 = this.option_panel;
        if (t1.use_custom === true)
          cp.addAll$1(cp, t1.custom_chars);
      }
      i = 0;
      while (true) {
        t1 = this.option_panel;
        ...
        t2 = this.output_panel;
        t3 = J.JSString;
        t1 = new N.RandomPassword(null, cp, t1.length);
  ...
  get$submit_handler: function() {
    return new H.BoundClosure$1(this, R.RandstrsApp.prototype.submit_handler$1, null, "submit_handler$1");
  },
  clear_handler$1: function(e) {
    var t1 = this.option_panel;
    t1.reset$0(t1);
    t1 = this.output_panel;
    t1.reset$0(t1);
  },
  get$clear_handler: function() {
    return new H.BoundClosure$1(this, R.RandstrsApp.prototype.clear_handler$1, null, "clear_handler$1");
  }
}}],
]);
...
function dart_precompiled($collectedClasses) {
  ...
  function NavBar(page_name, nav_list_left, nav_list_right, nav_list) {
    this.page_name = page_name;
    this.nav_list_left = nav_list_left;
    this.nav_list_right = nav_list_right;
    this.nav_list = nav_list;
  }
  NavBar.builtin$cls = "NavBar";
  if (!"name" in NavBar)
    NavBar.name = "NavBar";
  $desc = $collectedClasses.NavBar;
  if ($desc instanceof Array)
    $desc = $desc[1];
  NavBar.prototype = $desc;
  function RandomOptionPanel(length_input, repeat_input, length, repeat, default_length, default_repeat, all_chars_checkbox, upper_checkbox, lower_checkbox, digits_checkbox, special_checkbox, use_all, use_upper, use_lower, use_digits, use_special, custom_checkbox, use_custom, custom_input, custom_chars, pattern_checkbox, use_pattern, pattern_input, pattern, gen_button, clear_button) {
    this.length_input = length_input;
    this.repeat_input = repeat_input;
    this.length = length;
    this.repeat = repeat;
    this.default_length = default_length;
    this.default_repeat = default_repeat;
    this.all_chars_checkbox = all_chars_checkbox;
    this.upper_checkbox = upper_checkbox;
    this.lower_checkbox = lower_checkbox;
    this.digits_checkbox = digits_checkbox;
    this.special_checkbox = special_checkbox;
    this.use_all = use_all;
    this.use_upper = use_upper;
    this.use_lower = use_lower;
    this.use_digits = use_digits;
    this.use_special = use_special;
    this.custom_checkbox = custom_checkbox;
    this.use_custom = use_custom;
    this.custom_input = custom_input;
    this.custom_chars = custom_chars;
    this.pattern_checkbox = pattern_checkbox;
    this.use_pattern = use_pattern;
    this.pattern_input = pattern_input;
    this.pattern = pattern;
    this.gen_button = gen_button;
    this.clear_button = clear_button;
  }
  RandomOptionPanel.builtin$cls = "RandomOptionPanel";
  if (!"name" in RandomOptionPanel)
    RandomOptionPanel.name = "RandomOptionPanel";
  $desc = $collectedClasses.RandomOptionPanel;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RandomOptionPanel.prototype = $desc;
  RandomOptionPanel.prototype.get$length = function(receiver) {
    return this.length;
  };
  function OutputPanel(table, body) {
    this.table = table;
    this.body = body;
  }
  OutputPanel.builtin$cls = "OutputPanel";
  if (!"name" in OutputPanel)
    OutputPanel.name = "OutputPanel";
  $desc = $collectedClasses.OutputPanel;
  if ($desc instanceof Array)
    $desc = $desc[1];
  OutputPanel.prototype = $desc;
  function RandomPassword(items, pool, length) {
    this.items = items;
    this.pool = pool;
    this.length = length;
  }
  RandomPassword.builtin$cls = "RandomPassword";
  if (!"name" in RandomPassword)
    RandomPassword.name = "RandomPassword";
  $desc = $collectedClasses.RandomPassword;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RandomPassword.prototype = $desc;
  function PatternPassword(pattern, char_pools, char_count, items, pool, length) {
    this.pattern = pattern;
    this.char_pools = char_pools;
    this.char_count = char_count;
    this.items = items;
    this.pool = pool;
    this.length = length;
  }
  PatternPassword.builtin$cls = "PatternPassword";
  if (!"name" in PatternPassword)
    PatternPassword.name = "PatternPassword";
  $desc = $collectedClasses.PatternPassword;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PatternPassword.prototype = $desc;
  function CharPool(items, random) {
    this.items = items;
    this.random = random;
  }
  CharPool.builtin$cls = "CharPool";
  if (!"name" in CharPool)
    CharPool.name = "CharPool";
  $desc = $collectedClasses.CharPool;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CharPool.prototype = $desc;
  function ClientSecureRandom() {
  }
  ClientSecureRandom.builtin$cls = "ClientSecureRandom";
  if (!"name" in ClientSecureRandom)
    ClientSecureRandom.name = "ClientSecureRandom";
  $desc = $collectedClasses.ClientSecureRandom;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ClientSecureRandom.prototype = $desc;
  function RandomSequence(length) {
    this.length = length;
  }
  RandomSequence.builtin$cls = "RandomSequence";
  if (!"name" in RandomSequence)
    RandomSequence.name = "RandomSequence";
  $desc = $collectedClasses.RandomSequence;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RandomSequence.prototype = $desc;
  RandomSequence.prototype.get$length = function(receiver) {
    return this.length;
  };
  function RandstrsApp(option_panel, output_panel) {
    this.option_panel = option_panel;
    this.output_panel = output_panel;
  }
  RandstrsApp.builtin$cls = "RandstrsApp";
  if (!"name" in RandstrsApp)
    RandstrsApp.name = "RandstrsApp";
  $desc = $collectedClasses.RandstrsApp;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RandstrsApp.prototype = $desc;
