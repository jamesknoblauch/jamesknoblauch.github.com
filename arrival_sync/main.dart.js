...
$$.BoundClosure$20 = [G, {"": "BoundClosure;_self,_target,_receiver,__js_helper$_name",
  call$2: function(p0, p1) {
    return this._target.call(this._self, p0, p1);
  },
  $is_args2: true
...
["", "package:arrival_sync/src/arrival_sync.dart", , Z, {
...
random_color: function() {
  var r, g, b;
  r = C.JSNumber_methods.toInt$0(Z.rand_range(0, 255));
  g = C.JSNumber_methods.toInt$0(Z.rand_range(0, 255));
  b = C.JSNumber_methods.toInt$0(Z.rand_range(0, 255));
  return "rgb(" + r + ", " + g + ", " + b + ")";
},

UnitField: {"": "Object;_canvas,_context,_rect,width,height,unit_count,_units,_unit_queue,_arrival_sync$_target,_board",
  gen_units$0: function() {
    var t1, t2, i, t3, t4;
    t1 = this.unit_count;
    t2 = P.List_List(t1, Z.Unit);
  ...
  draw$1: function(_) {
    ...
    t1 = this._unit_queue.nodes.length;
    t2 = this._context;
    t3 = this.width;
    t4 = this.height;
    if (t1 === 0) {
      t2.clearRect(0, 0, t3, t4);
      this._board.draw$1(t2);
      this.gen_units$0();
    } else {
      t2.clearRect(0, 0, t3, t4);
      this._board.draw$1(t2);
  ...
  draw_units$1: function(context) {
    var t1;
    for (t1 = this._units, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();)
      t1._current.draw$1(context);
  },
  UnitField$2: function(_canvas, unit_count) {
    var t1, t2;
    t1 = this._canvas;
    this._context = J.get$context2D$x(t1);
    t2 = t1.parentElement;
    t2 = new P.Rectangle(t2.clientLeft, t2.clientTop, t2.clientWidth, t2.clientHeight);
    ...
    this._board = Z.Board$(t1, 30);
    this.gen_units$0();
    t1 = this._context;
    t1.clearRect(0, 0, this.width, this.height);
    this._board.draw$1(t1);
    t1 = window;
    t2 = this.get$draw();
    C.Window_methods._ensureRequestAnimationFrame$0(t1);
    C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(t2));
  ...
  static: {
UnitField$: function(_canvas, unit_count) {
  var t1 = new Z.UnitField(_canvas, null, null, null, null, unit_count, null, null, null, null);
  t1.UnitField$2(_canvas, unit_count);
  return t1;
}}
...
Unit: {"": "Object;size,color?,_board,_tile,_destination,_destination_distance,_path,_arrival_sync$_target",
  ...
  get$destination_distance: function() {
    return this._destination_distance;
  },
  draw$1: function(context) {
    ...
    context.beginPath();
    context.arc(J.$index$asx(J.get$position$x(this._tile), 0), J.$index$asx(J.get$position$x(this._tile), 1), this.size, 0, 6.283185307179586, false);
    context.fill();
    context.stroke();
    context.closePath();
  },
  draw_path$1: function(context) {
    var t1, t;
    for (t1 = this._path, t1.toString, t1 = P._ListQueueIterator$(t1); t1.moveNext$0();) {
      t = t1._collection$_current;
      t.set$color(this.color);
      t.draw$1(context);
      t.calc_color$0();
    }
  },
  compareTo$1: function(_, other) {
    var t1, t2;
    t1 = this._destination_distance;
    t2 = other.get$destination_distance();
    if (typeof t1 !== "number")
      throw t1.$lt();
    if (typeof t2 !== "number")
      throw H.iae(t2);
    if (t1 < t2)
      ...
      t2 = other._destination_distance;
      if (typeof t2 !== "number")
        throw H.iae(t2);
      if (t1 > t2)
        return 1;
  ...
  toString$0: function(_) {
    return J.toString$0(this._tile);
  },
  Unit$4: function(_tile, _target, size, color) {
    var t1;
    this._board = this._tile.get$board();
    t1 = this._arrival_sync$_target;
    if (t1 != null) {
      this._destination = t1._tile;
      this._calc_path$0();
    }
    if (this.color == null)
      this.color = Z.random_color();
  },
  static: {
Unit$: function(_tile, _target, size, color) {
  var t1 = new Z.Unit(size, color, null, _tile, null, null, null, _target);
  t1.Unit$4(_tile, _target, size, color);
  return t1;
}}

},

Board: {"": "Object;_tiles,_board_graph,_canvas,_context,_rect,_tile_size,_width,_height",
  gen_tiles$0: function() {
    var t1, y, t2, y0, i, t3, x, j, t4, tile;
    t1 = this._tile_size;
    y = C.JSInt_methods.$tdiv(t1, 2);
    for (t2 = this._tiles, y0 = y, i = 0; i < this._height; ++i) {
      t3 = P.List_List(null, Z.Tile);
      t3.$builtinTypeInfo = [Z.Tile];
      t2.$indexSet(t2, i, t3);
      for (x = y, j = 0; j < this._width; ++j) {
        t3 = new U.Vector(null);
        t4 = P.List_List(2, J.JSNumber);
        t4.$builtinTypeInfo = [J.JSNumber];
        t3.items = t4;
        tile = new Z.Tile(null, null, 10, t1, t3, this);
        t3 = tile._arrival_sync$_position.items;
        t4 = t3.length;
        if (0 >= t4)
          throw H.ioore(t3, 0);
        t3[0] = x;
  ...
  gen_graph$0: function() {
    var t1, t2, edge_e, edge_se, edge_s, d, i, i0, j, t3, t4, t5;
    for (t1 = this._board_graph, t2 = this._tiles, edge_e = null, edge_se = null, edge_s = null, d = null, i = 0; i < this._height; i = i0)
      for (i0 = i + 1, j = 0; t3 = this._width, j < t3; ++j) {
        if (j < t3 - 1) {
          t3 = J.get$elevation$x(J.$index$asx(t2.$index(t2, i), j));
          t4 = j + 1;
          t5 = J.get$elevation$x(J.$index$asx(t2.$index(t2, i), t4));
          if (typeof t3 !== "number")
            throw t3.$sub();
          if (typeof t5 !== "number")
            throw H.iae(t5);
          d = Math.abs(t3 - t5);
          edge_e = new D.WeightedEdge(J.$index$asx(t2.$index(t2, i), j), J.$index$asx(t2.$index(t2, i), t4), d);
          edge_e.$builtinTypeInfo = [null];
          t1.add_edge$1(edge_e);
        }
        if (i < this._height - 1) {
          t3 = J.get$elevation$x(J.$index$asx(t2.$index(t2, i), j));
          t4 = J.get$elevation$x(J.$index$asx(t2.$index(t2, i0), j));
          if (typeof t3 !== "number")
            throw t3.$sub();
          if (typeof t4 !== "number")
            throw H.iae(t4);
          d = Math.abs(t3 - t4);
          edge_s = new D.WeightedEdge(J.$index$asx(t2.$index(t2, i), j), J.$index$asx(t2.$index(t2, i0), j), d);
          edge_s.$builtinTypeInfo = [null];
          t1.add_edge$1(edge_s);
        }
        if (i < this._height - 1 && j < this._width - 1) {
          t3 = J.get$elevation$x(J.$index$asx(t2.$index(t2, i), j));
          t4 = j + 1;
          t5 = J.get$elevation$x(J.$index$asx(t2.$index(t2, i0), t4));
          if (typeof t3 !== "number")
            throw t3.$sub();
          if (typeof t5 !== "number")
            throw H.iae(t5);
          d = Math.abs(t3 - t5);
          edge_se = new D.WeightedEdge(J.$index$asx(t2.$index(t2, i), j), J.$index$asx(t2.$index(t2, i0), t4), d);
          edge_se.$builtinTypeInfo = [null];
          t1.add_edge$1(edge_se);
        }
      }
  },
  ...
  draw$1: function(context) {
    var t1, i, t2;
    for (t1 = this._tiles, i = 0; i < t1._collection$_length; ++i)
      for (t2 = J.get$iterator$ax(t1.$index(t1, i)); t2.moveNext$0();)
        t2.get$current().draw$1(this._context);
  },
  get$random_tile: function() {
    var i, j, t1;
    i = C.JSNumber_methods.toInt$0(Z.rand_range(0, this._height));
    j = C.JSNumber_methods.toInt$0(Z.rand_range(0, this._width));
    t1 = this._tiles;
    return J.$index$asx(t1.$index(t1, i), j);
  },
  Board$2: function(_canvas, _tile_size) {
    var t1, t2;
    t1 = this._canvas;
    this._context = J.get$context2D$x(t1);
    t2 = t1.parentElement;
    ...
    H.setRuntimeTypeInfo(t2, [null]);
    this._rect = t2;
    t1.width = this._rect.width;
    t1.height = this._rect.height;
    t1 = this._rect.width;
    t2 = this._tile_size;
    if (typeof t1 !== "number")
      throw t1.$tdiv();
    this._width = C.JSInt_methods.$tdiv(t1, t2);
    t1 = this._rect.height;
    if (typeof t1 !== "number")
      throw t1.$tdiv();
    this._height = C.JSInt_methods.$tdiv(t1, t2);
    this.gen_tiles$0();
    this.gen_graph$0();
  },
  static: {
Board$: function(_canvas, _tile_size) {
  var t1 = new Z.Board(P.HashMap_HashMap(null, null, null, J.JSInt, [J.JSArray, Z.Tile]), D.EdgeWeightedGraph$(null, null), _canvas, null, null, _tile_size, null, null);
  t1.Board$2(_canvas, _tile_size);
  return t1;
}}

},

Tile: {"": "Object;_color,_elevation,max_elevation,_size,_arrival_sync$_position,_board",
  get$elevation: function(_) {
    return this._elevation;
  },
  get$position: function(_) {
    return this._arrival_sync$_position;
  },
  ...
  calc_color$0: function() {
    this._color = "rgb(0, " + C.JSInt_methods.$mod(C.JSInt_methods.$tdiv(255, C.JSNumber_methods.toInt$0(J.roundToDouble$0$n(this._elevation)) + 2) * 2, 255) + ", 0)";
  },
  draw$1: function(context) {
    var t1, t2, t3, t4, t5;
    context.lineWidth = 0.5;
    ...
    context.strokeStyle = "black";
    context.beginPath();
    t1 = this._arrival_sync$_position;
    t2 = t1.items;
    if (0 >= t2.length)
      throw H.ioore(t2, 0);
    t3 = this._size;
    ...
    if (1 >= t5.length)
      throw H.ioore(t5, 1);
    context.rect(t2, J.$sub$n(t5[1], t4), t3, t3);
    context.fill();
    context.stroke();
    context.closePath();
    ...
    if (1 >= t5)
      throw H.ioore(t1, 1);
    C.CanvasRenderingContext2D_methods.fillText$4(context, t4, t2, t1[1], t3);
    context.stroke();
    context.closePath();
  }
}}],
...
Queue: {"": "Object;", $isEfficientLength: true},
...
["graph", "package:arrival_sync/graph.dart", , D, {
WeightedEdge: {"": "Object;u<,v,weight<",
  get_connected_node$1: function(node) {
    var t1, t2;
    t1 = this.u;
    t2 = J.getInterceptor(node);
    if (t2.$eq(node, t1))
      return this.v;
    else if (t2.$eq(node, this.v))
      return t1;
    else
      return;
  },
  compareTo$1: function(_, edge) {
    var t1, t2;
    t1 = this.weight;
    t2 = J.getInterceptor$n(t1);
    if (t2.$gt(t1, edge.get$weight()))
      return 1;
    else if (t2.$lt(t1, edge.weight))
      return -1;
    else
      return 0;
  },
  toString$0: function(_) {
    return "(" + H.S(this.u) + ", " + H.S(this.v) + ", " + H.S(this.weight) + ")";
  }
},

EdgeWeightedGraph: {"": "Object;nodes",
  add_edge$1: function(edge) {
    var u, v, t1, u_edges, v_edges, $arguments;
    u = edge.u;
    v = edge.get_connected_node$1(u);
    t1 = this.nodes;
    u_edges = t1.$index(t1, u);
    t1 = this.nodes;
    v_edges = t1.$index(t1, v);
    if (u_edges != null) {
      t1 = J.getInterceptor$asx(u_edges);
      if (t1.contains$1(u_edges, edge) !== true)
        t1.add$1(u_edges, edge);
    } else {
      $arguments = H.substitute(this.$asEdgeWeightedGraph, H.getRuntimeTypeInfo(this));
      t1 = $arguments == null ? null : $arguments[0];
      u_edges = P.List_List(null, [D.WeightedEdge, t1]);
      $arguments = H.substitute(this.$asEdgeWeightedGraph, H.getRuntimeTypeInfo(this));
      t1 = $arguments == null ? null : $arguments[0];
      u_edges.$builtinTypeInfo = [[D.WeightedEdge, t1]];
      u_edges.push(edge);
      t1 = this.nodes;
      t1.$indexSet(t1, u, u_edges);
    }
    if (v_edges != null) {
      if (J.contains$1$asx(u_edges, edge) !== true)
        J.add$1$ax(v_edges, edge);
    } else {
      $arguments = H.substitute(this.$asEdgeWeightedGraph, H.getRuntimeTypeInfo(this));
      t1 = $arguments == null ? null : $arguments[0];
      v_edges = P.List_List(null, [D.WeightedEdge, t1]);
      $arguments = H.substitute(this.$asEdgeWeightedGraph, H.getRuntimeTypeInfo(this));
      t1 = $arguments == null ? null : $arguments[0];
      v_edges.$builtinTypeInfo = [[D.WeightedEdge, t1]];
      v_edges.push(edge);
      t1 = this.nodes;
      t1.$indexSet(t1, v, v_edges);
    }
  },
  toString$0: function(_) {
    var t1, t2, output_str, node_key, node_edges;
    for (t1 = this.nodes, t2 = new P.HashMapKeyIterable(t1), H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_HashMap", 0)]), t2 = t2._map, t2 = new P.HashMapKeyIterator(t2, t2._computeKeys$0(), 0, null), output_str = ""; t2.moveNext$0();) {
      node_key = t2._collection$_current;
      output_str = C.JSString_methods.$add(output_str, J.$add$ns(J.toString$0(node_key), ": "));
      t1 = this.nodes;
      node_edges = t1.$index(t1, node_key);
      output_str = (node_edges != null ? C.JSString_methods.$add(output_str, J.toString$0(node_edges)) : output_str) + "\n";
    }
    return output_str;
  },
  EdgeWeightedGraph$1: function(edges, $T) {
    this.nodes = P.HashMap_HashMap(null, null, null, $T, [J.JSArray, [D.WeightedEdge, $T]]);
  },
  static: {
EdgeWeightedGraph$: function(edges, $T) {
  var t1 = new D.EdgeWeightedGraph(null);
  H.setRuntimeTypeInfo(t1, [$T]);
  t1.EdgeWeightedGraph$1(edges, $T);
  return t1;
}}
...
Dijkstra: {"": "Object;_explored_nodes,_unexplored_edges,_distance,_previous,_graph,_graph$_path,_mod",
  ...
  search$2: function(_, source, target) {
    ...
    t1 = this._distance;
    t1.$indexSet(t1, source, 0);
    this._explore$1(source);
    for (t1 = this._unexplored_edges, t2 = this._explored_nodes; t1.nodes.length !== 0;) {
      edge = t1.extract$0();
      u = edge.get$u();
      v = edge.get_connected_node$1(u);
      if (!C.JSArray_methods.contains$1(t2, u))
        this._explore$1(u);
      if (!C.JSArray_methods.contains$1(t2, v))
        this._explore$1(v);
      if (J.$eq(u, target) || J.$eq(v, target))
        break;
    }
    for (t1 = this._previous, t2 = this._graph$_path, node = target; t1.$index(t1, node) != null;) {
      t2.addFirst$1(node);
      node = t1.$index(t1, node);
    }
    return t2;
  },
  Dijkstra$2: function(_graph, _mod, $T) {
    ...
    for (t1 = this._graph.nodes, t2 = new P.HashMapKeyIterable(t1), H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_HashMap", 0)]), t2 = t2._map, t2 = new P.HashMapKeyIterator(t2, t2._computeKeys$0(), 0, null), t1 = this._distance, t3 = this._previous; t2.moveNext$0();) {
      ...
      t1.$indexSet(t1, node, 20000000);
      t3.$indexSet(t3, node, null);
    }
  },
  static: {
...
["heap", "package:arrival_sync/heap.dart", , G, {
Heap: {"": "Object;nodes,_compare",
  _compare$2: function(arg0, arg1) {
    return this._compare.call$2(arg0, arg1);
  },
  _min_compare$2: function(e1, e2) {
    return J.compareTo$1$ns(e1, e2);
  },
  get$_min_compare: function() {
    return new G.BoundClosure$20(this, G.Heap.prototype._min_compare$2, null, "_min_compare$2");
  },
  _max_compare$2: function(e1, e2) {
    return -J.compareTo$1$ns(e1, e2);
  },
  get$_max_compare: function() {
    return new G.BoundClosure$20(this, G.Heap.prototype._max_compare$2, null, "_max_compare$2");
  },
  extract$0: function() {
    var t1, t2, node;
    t1 = this.nodes;
    ...
    if (t2 === 0)
      ...
      node = t1[0];
      this._delete$1(0);
      this._heapify_down$1(0);
    }
    return node;
  },
  _delete$1: function(i) {
    var t1;
    this._swap$2(i, this.nodes.length - 1);
    t1 = this.nodes;
    if (0 >= t1.length)
      throw H.ioore(t1, 0);
    t1.pop();
    this._heapify_down$1(i);
  },
  ...
  _pick_child$2: function(i, j) {
    ...
    if (j < 0 || j >= t2)
      throw H.ioore(t1, j);
    if (J.$lt$n(this._compare$2(t3, t1[j]), 0))
      choice = i;
    else {
      t1 = this.nodes;
      t2 = t1.length;
      ...
      if (j >= t2)
        throw H.ioore(t1, j);
      choice = J.$gt$n(this._compare$2(t3, t1[j]), 0) ? j : i;
    }
    return choice;
  },
  _heapify_up$1: function(i) {
    var $parent, t1, t2, t3, parent0;
    $parent = C.JSInt_methods.$tdiv(i - 1, 2);
    while (true) {
      if (i > 0) {
        t1 = this.nodes;
        t2 = t1.length;
        ...
        if ($parent < 0 || $parent >= t2)
          throw H.ioore(t1, $parent);
        t1 = J.$lt$n(this._compare$2(t3, t1[$parent]), 0);
      } else
        t1 = false;
      if (!t1)
        break;
      this._swap$2(i, $parent);
      parent0 = C.JSInt_methods.$tdiv($parent - 1, 2);
      i = $parent;
      $parent = parent0;
    }
  },
  _heapify_down$1: function(i) {
    var left_child, end, left_child0, child_to_swap, t1, t2, t3;
    left_child = 2 * i + 1;
    end = this.nodes.length - 1;
    for (left_child0 = end + 1; left_child <= end;) {
      child_to_swap = left_child < end ? this._pick_child$2(left_child, left_child + 1) : left_child;
      t1 = this.nodes;
      t2 = t1.length;
      if (child_to_swap < 0 || child_to_swap >= t2)
        throw H.ioore(t1, child_to_swap);
      t3 = t1[child_to_swap];
      if (i < 0 || i >= t2)
        throw H.ioore(t1, i);
      if (J.$lt$n(this._compare$2(t3, t1[i]), 0)) {
        this._swap$2(child_to_swap, i);
        left_child = 2 * child_to_swap + 1;
        i = child_to_swap;
      } else
        left_child = left_child0;
    }
  },
  Heap$max$0: function($T) {
    var t1 = P.List_List(null, $T);
    H.setRuntimeTypeInfo(t1, [$T]);
    this.nodes = t1;
    this._compare = this.get$_max_compare();
  },
  Heap$1: function(comparator, $T) {
    var t1 = P.List_List(null, $T);
    H.setRuntimeTypeInfo(t1, [$T]);
    this.nodes = t1;
    this._compare = this.get$_min_compare();
  },
  static: {
Heap$: function(comparator, $T) {
  var t1 = new G.Heap(null, null);
  H.setRuntimeTypeInfo(t1, [$T]);
  t1.Heap$1(comparator, $T);
  return t1;
},
...
["", "main.dart", , F, {
main: function() {
  Z.UnitField$(document.querySelector("#canvas_area"), 30);
}},
1],
["vector", "package:arrival_sync/vector.dart", , U, {
Vector: {"": "Object;items",
  $index: function(_, i) {
    var t1 = this.items;
  ...
  $add: function(_, other) {
    var new_vec, t1, i, t2, t3;
    new_vec = U.Vector$(this.items.length);
    for (t1 = J.getInterceptor$asx(other), i = 0; t2 = this.items, i < t2.length; ++i) {
      t2 = J.$add$ns(t2[i], t1.$index(other, i));
      t3 = new_vec.items;
      if (i >= t3.length)
        throw H.ioore(t3, i);
      t3[i] = t2;
  ...
  add$1: function(_, other) {
    var i, t1, t2;
    for (i = 0; t1 = this.items, i < t1.length; ++i) {
      t1 = J.$add$ns(t1[i], other.$index(other, i));
      t2 = this.items;
      if (i >= t2.length)
        throw H.ioore(t2, i);
      t2[i] = t1;
  ...
  $sub: function(_, other) {
    ...
    new_vec = U.Vector$(this.items.length);
    for (i = 0; t1 = this.items, i < t1.length; ++i) {
      t1 = J.$sub$n(t1[i], C.JSNumber_methods.$index(other, i));
      t2 = new_vec.items;
      if (i >= t2.length)
        throw H.ioore(t2, i);
      t2[i] = t1;
  ...
  get$magnitude: function() {
    var t1, sum, x;
    for (t1 = this.items, t1 = new H.ListIterator(t1, t1.length, 0, null), sum = 0; t1.moveNext$0();) {
      x = t1._current;
      if (typeof x !== "number")
  ...
  compareTo$1: function(_, other) {
    if (this.get$magnitude() > other.get$magnitude())
      return 1;
    else if (this.get$magnitude() < other.get$magnitude())
      return -1;
    else
      return 0;
  },
  Vector$1: function(size) {
    var t1 = P.List_List(size, J.JSNumber);
    H.setRuntimeTypeInfo(t1, [J.JSNumber]);
    this.items = t1;
  },
  static: {
Vector$: function(size) {
  var t1 = new U.Vector(null);
  t1.Vector$1(size);
  return t1;
}}
...
Z.Unit.$isObject = true;
D.WeightedEdge.$isObject = true;
...
P.Queue.$isQueue = true;
P.Queue.$isObject = true;
...
J.get$elevation$x = function(receiver) {
  return J.getInterceptor$x(receiver).get$elevation(receiver);
};
